...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('users.store')}}">
    ...
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input required type="text" class="form-control form-control-solid"  name="first_name" value=""/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input required type="text" class="form-control form-control-solid"  name="last_name" value=""/>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
