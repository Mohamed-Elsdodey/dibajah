...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('cities.update',$city->id)}}">
    ...
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="name_ar" required type="text" class="form-control form-control-solid"  name="name_ar" value="{{$city->name_ar}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="name_en" required type="text" class="form-control form-control-solid"  name="name_en" value="{{$city->name_en}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-4">
            ...
            <!--end::Label-->
            <input id="iso_code" required type="text" class="form-control form-control-solid"  name="iso_code" value="{{$city->iso_code}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-12">
            ...
            <select required id="serviceChange" class=" form-control   " name="area_id"
                ...
                @foreach($areas as $area)
                    <option @if($city->area_id==$area->id) selected @endif value="{{$area->id}}">{{$area->name_ar}}</option>
                @endforeach
