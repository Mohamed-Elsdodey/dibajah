...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('categories.update',$category->id)}}">
    ...
    <div class="row g-4">
        <div class="form-group">
            ...
            <input type="file" class="dropify" name="image" data-default-file="{{get_file($category->image)}}"
                   accept="image/*"/>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="title_ar" required type="text" class="form-control form-control-solid" name="title_ar" value="{{$category->title_ar}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="title_en" required type="text" class="form-control form-control-solid" name="title_en" value="{{$category->title_en}}"/>
        </div>
